...
function copyAssets (done) {
    var assets = {
        ...
        scss: [
            ...
            "./node_modules/tablesaw/dist/stackonly/tablesaw.stackonly.scss"
        ],
    };
    ...
    var third_party_assets = {
        css_js: [
            ...
            {"name": "tablesaw", "assets": ["./node_modules/tablesaw/dist/tablesaw.jquery.js", "./node_modules/tablesaw/dist/tablesaw.css"]},
            {
...
function imageMin() {
    ...
    return gulp
        .src([folder.src + "images/**/*", "!" + folder.src + "images/GSDeluxe/**/*.svg", "!" + folder.src + "images/GSDeluxe"])
        .pipe(newer(out))
        .pipe(imagemin())
        .pipe(gulp.dest(out));
}
...
function javascript() {
    ...
    var app_pages_assets = {
        js: [
            ...
            folder.src + "js/pages/datetime.init.js",
            folder.src + "js/GSDeluxe/gdx-table.js",
            folder.src + "js/GSDeluxe/gdx-table.init.js"
        ]
    };
...
function svg() {
	...
	return gulp.src(folder.src + 'images/GSDeluxe/**/*.svg')
		.pipe(svgSprite(config))
		.on('error', function(error) {
			console.log(error)
		})
		.pipe(gulp.dest(folder.src + 'images/'));
		//.pipe(gulp.dest(folder.dist_assets + 'images/GSDeluxe/'));
}
...
function watchFiles() {
    ...
    gulp.watch(folder.src + "images/GSDeluxe/**/*", gulp.series(svg, reloadBrowserSync));
}
// watch all changes
